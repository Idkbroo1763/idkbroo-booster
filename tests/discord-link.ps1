...
if (-not $source.Contains("`$script:appVersion = '1.3.15'")) { throw 'Application version was not updated to 1.3.15' }
...
foreach ($requiredControlFeature in @(
 ...
 'Profil keresése:', 'Gyorsprofilok', 'DoNotDisturbCheck', 'ToolTip=',
